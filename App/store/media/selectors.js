export const getMediaData = state => state.media.mediaData;
export const getGenres = state => state.media.genres;
export const getMediaType = state => state.media.mediaType;
